...
mixin HomePageMixin on GetxController {
 ...
 Future<List<DestinationModel>> getFavouritePlacesPrefs() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String> destinations = prefs.getStringList("intrests") ?? ["beach", "mountain", "camping"];
    return await getFavouritePlaces(["beach"]);
    // getDestinations(destinations);
  }

  Future<List<DestinationModel>> getFavouritePlaces(
